...
CONFIG = [
    {
        'id': 1,
        'name': 'layer1',
        'directory': 'fimmick-cmi/v9.1/normal/layer1',
        'required': True,
        'rarity_weights': None,
    },
    {
        'id': 2,
        'name': 'layer2',
        'directory': 'fimmick-cmi/v9.1/normal/layer2',
        'required': True,
        'rarity_weights': None,
    },
    {
        'id': 3,
        'name': 'layer3',
        'directory': 'fimmick-cmi/v9.1/normal/layer3',
        'required': True,
        'rarity_weights': None,
    },
    {
        'id': 4,
        'name': 'layer4',
        'directory': 'fimmick-cmi/v9.1/normal/layer4',
        'required': True,
        'rarity_weights': None,
    },
    {
        'id': 5,
        'name': 'layer5',
        'directory': 'fimmick-cmi/v9.1/normal/layer5',
        'required': True,
        'rarity_weights': None,
    }
]
